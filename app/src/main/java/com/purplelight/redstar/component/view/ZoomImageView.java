...
public class ZoomImageView extends View implements Observer {
    ...
    protected void onDraw(Canvas canvas) {
        if (mBitmap != null && mState != null) {
            ...
            Log.d(TAG, "mRectDst.top=" + mRectDst.top);
            Log.d(TAG, "mRectDst.bottom=" + mRectDst.bottom);
            Log.d(TAG, "mRectDst.left=" + mRectDst.left);
            Log.d(TAG, "mRectDst.right=" + mRectDst.right);
